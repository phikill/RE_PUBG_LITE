...
public:
	...
	unsigned char                                      bCanMoveWhenNoTarget : 1;                                 // 0x00DC(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05 : 8;                                        // 0x00DD(0x0001)
	unsigned char                                      bCheckWallPass : 1;                                       // 0x00DD(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData06 : 8;                                        // 0x00DE(0x0001)
	unsigned char                                      DebugDrawPath : 1;                                        // 0x00DE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
