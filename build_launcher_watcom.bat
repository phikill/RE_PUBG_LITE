...
echo.
echo.
@wcc386 -ecc /6r -fp6 -ms -ot -zkl -ol -i="src" -i="src/lpc_launcher" "src/lpc_launcher/LauncherMain/LOG_manager.c" -fo="bin/lpc_launcher/" ^
     2>&1 | findstr /V /C:"Open Watcom" /C:"Portions" /C:"See"
...
@wcc386 -ecc /6r -fp6 -ms -ot -zkl -ol  -Dcef_enable_single_process ^
          -i="src" -i="src/include" -i="src/lpc_launcher" "src/lpc_launcher/LauncherView/__App.c" -fo="bin/lpc_launcher/" ^
     2>&1 | findstr /V /C:"Open Watcom" /C:"Portions" /C:"See"
...
@wcc386 -ecc /6r -fp6 -ms -ot -zkl -ol  ^
