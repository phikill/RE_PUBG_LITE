...
class APickUp_BP_Helmet_Lv3_C : public APickUpWrapperActor
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass PickUp_BP_Helmet_Lv3.PickUp_BP_Helmet_Lv3_C");
		return ptr;
	}
