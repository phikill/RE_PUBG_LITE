...
public:
	...
	int                                                BP_ChatEmoji_ClickIndex;                                  // 0x0398(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("ScriptBlueprintGeneratedClass bp_chat_emoji.bp_chat_emoji_C");
		return ptr;
	}
