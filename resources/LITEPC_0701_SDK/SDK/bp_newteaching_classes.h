...
public:
	...
	int                                                BP_NewteachingUI_CurrentSelectIdx;                        // 0x0398(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("ScriptBlueprintGeneratedClass bp_newteaching.bp_newteaching_C");
		return ptr;
	}
