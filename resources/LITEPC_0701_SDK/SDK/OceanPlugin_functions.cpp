...
// Function OceanPlugin.BuoyancyForceComponent.GetTestPointsUnderWater
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UBuoyancyForceComponent::GetTestPointsUnderWater()
{
	static auto fn = UObject::FindObject<UFunction>("Function OceanPlugin.BuoyancyForceComponent.GetTestPointsUnderWater");

	UBuoyancyForceComponent_GetTestPointsUnderWater_Params params;
