...
class UBattleItemHandle_MainWeaponPC_C : public UBattleItemHandleBase_BP_C
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BattleItemHandle_MainWeaponPC.BattleItemHandle_MainWeaponPC_C");
		return ptr;
	}
	...
	void UpdateEquipedAttach(EWeaponAttachmentSocketType WeapAttachSockType, class UBattleItemHandle_WeapAttachmentPC_C* WeapAttachItemHandle, bool IsEquip);
