...
public:
	...
	struct FBP_STRUCT_ShareHonorWall_ShareInfo         BP_STRUCT_ShareHonorWall_ShareInfo;                       // 0x0398(0x0038) (Edit, BlueprintVisible)
	class USceneComponent*                             DefaultSceneRoot;                                         // 0x03D0(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("ScriptBlueprintGeneratedClass bp_share_honor_wall.bp_share_honor_wall_C");
		return ptr;
	}
