...
// 0x03D2 (0x0682 - 0x02B0)
class UGrenadeInfoItem_BP_C : public UUAEUserWidget
{
public:
	...
	class ABP_GrenadeWeaponStudio_C*                   ItemStudio;                                               // 0x0670(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	...
	TEnumAsByte<EGrenadeType>                          grenadeType;                                              // 0x0681(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass GrenadeInfoItem_BP.GrenadeInfoItem_BP_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_GrenadeInfoItem_BP(int EntryPoint);
