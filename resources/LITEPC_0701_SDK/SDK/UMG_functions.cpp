...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.Widget.GetCachedAllottedGeometry");
...
struct FVector2D USlateBlueprintLibrary::STATIC_GetAbsolutePosition(const struct FGeometry& Geometry)
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.SlateBlueprintLibrary.GetAbsolutePosition");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.TextBlock.SetVerticalJustification");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WeakRefImage.UnloadTextureResource");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function UMG.WeakRefImage.LoadTextureResource");
