...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.AutoEquipAttachments");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.ReturnBullets");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.UpdateEquipedAttach");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.LocalHandleDisuse");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.CreateWrapperOnGround");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.GetAvailableTargetLogicSocketName");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.GetAvailableInstantLogicSocketName");
...
void UBattleItemHandle_MainWeapon_C::JudgeHasTargetAttachmentSlot(int TypeSpecificID, EWeaponAttachmentSocketType AttachType, bool* CanEquip, bool* HasOcupied)
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.JudgeHasTargetAttachmentSlot");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.HandleDisuse");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.HandleUse");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.HandleDrop");
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BattleItemHandle_MainWeapon.BattleItemHandle_MainWeapon_C.HandlePickup");
